...
class CfgPatches {
    class LineCompass {
        ...
        author = "TactiCool";
        authors[] = {"joko // Jonas", "NetFusion"};
        authorUrl = "https://github.com/taktiCool";
        url = "https://github.com/taktiCool";
        version = VERSION;
...
class cfgFunctions {
    class LineCompass {
        class LineCompass {
            file = "\tc\LineCompass\addons\LineCompass\functions";
            class addLineMarker { RECOMPILE; };
            class draw3d { RECOMPILE; };
            class postInit { postInit = 1; RECOMPILE; };
            class preInit { preInit = 1; RECOMPILE; };
            class removeLineMarker { RECOMPILE; };
        };
    };
};
...
class RscTitles {
    class GVAR(Compass) {
        idd = -1;
        duration = 1e11;
        onLoad = "uiNamespace setVariable ['LineCompass_Compass', _this select 0];";
        class Controls {
